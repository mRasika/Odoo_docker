...
################################################################################
{
    ...
    'assets': {
        'web.assets_backend': [
            'sl_salon_management/static/src/css/salon_dashboard.css',
            'sl_salon_management/static/src/js/salon_dashboard.js',
            'sl_salon_management/static/src/xml/salon_dashboard.xml',
        ],
        'web.assets_frontend': [
            'sl_salon_management/static/src/css/salon_website.css',
            'sl_salon_management/static/src/js/website_salon_booking.js',
        ],
    },
